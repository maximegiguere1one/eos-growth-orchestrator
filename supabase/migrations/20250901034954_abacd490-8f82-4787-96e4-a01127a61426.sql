...
-- Add foreign key constraint to eos_kpi_values table for referential integrity
ALTER TABLE public.eos_kpi_values 
ADD CONSTRAINT eos_kpi_values_kpi_id_fkey 
FOREIGN KEY (kpi_id) REFERENCES public.eos_kpis(id) ON DELETE CASCADE;
